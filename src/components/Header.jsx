...
export const Header = ({ stats }) => {
  return (
    <header className="w-full bg-gradient-to-r from-blue-600 via-blue-500 to-cyan-500 text-white shadow-lg sticky top-0 z-50">
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="flex flex-col gap-2">
            <div className="inline-flex items-center gap-2 w-fit">
              ...
              <span className="text-sm font-semibold text-cyan-100">Sincronizado con base de datos</span>
            </div>
            <h1 className="text-3xl sm:text-4xl font-bold tracking-tight">
              📦 Control de Inventario
            </h1>
            <p className="text-cyan-100 text-sm sm:text-base font-medium">
          ...
          {stats && (
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-4">
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-lg p-3 border border-white/20 hover:bg-white/20 transition-all">
                <div className="text-xs font-semibold text-cyan-100 uppercase tracking-wider mb-1">
                  Productos
                </div>
              ...
              {/* Stock Bajo */}
              <div className="bg-white/10 backdrop-blur-sm rounded-lg p-3 border border-white/20 hover:bg-white/20 transition-all">
                <div className="text-xs font-semibold text-yellow-200 uppercase tracking-wider mb-1">
                  Stock Bajo ⚠️
                </div>
                <div className={`text-2xl sm:text-3xl font-bold ${
                  stats.lowStockCount > 0 ? 'text-yellow-200' : 'text-white'
                }`}>
